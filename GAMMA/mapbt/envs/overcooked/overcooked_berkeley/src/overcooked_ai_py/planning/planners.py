...
def _atomic_pickle_dump(obj, filename):
    """Write pickle atomically to avoid readers observing partially written files."""
    tmp_filename = "{}.tmp.{}.{}".format(filename, os.getpid(), time.time_ns())
    try:
